...
namespace Server
{
    ...
    public class SkillInfo
    {
        ...
        public SkillInfo(int skillID, string name, double strScale, double dexScale, double intScale, string title, string ftitle, SkillUseCallback callback, double strGain, double dexGain, double intGain, double gainFactor)
        {
            m_Name = name;
            m_Title = title;
            m_FTitle = ftitle;
        ...
        private static SkillInfo[] m_Table = new SkillInfo[58]
			{
				new SkillInfo(  0, "Alchemy",			0.0,	5.0,	5.0,	"Alchimiste", "Alchimiste",	null,	0.0,	0.5,	0.5,	1.0 ),
				new SkillInfo(  1, "Anatomy",			0.0,	0.0,	0.0,	"Biologiste", "Biologiste",	null,	0.15,	0.15,	0.7,	1.0 ),
				new SkillInfo(  2, "Animal Lore",		0.0,	0.0,	0.0,	"Naturaliste", "Naturaliste",	null,	0.0,	0.0,	1.0,	1.0 ),
				new SkillInfo(  3, "Item Identification",	0.0,	0.0,	0.0,	"Marchand", "Marchande",	null,	0.0,	0.0,	1.0,	1.0 ),
				new SkillInfo(  4, "Arms Lore",			0.0,	0.0,	0.0,	"Maître d'Armes", "Maître d'Armes",	null,	0.75,	0.15,	0.1,	1.0 ),
				new SkillInfo(  5, "Parrying",			7.5,	2.5,	0.0,	"Gardien", "Gardien",	null,	0.75,	0.25,	0.0,	1.0 ),
				new SkillInfo(  6, "Begging",			0.0,	0.0,	0.0,	"Mendiant", "Mendiante",	null,	0.0,	0.0,	0.0,	1.0 ),
				new SkillInfo(  7, "Blacksmithy",		10.0,	0.0,	0.0,	"Forgeron", "Forgeronne",	null,	1.0,	0.0,	0.0,	1.0 ),
				new SkillInfo(  8, "Bowcraft/Fletching",	6.0,	16.0,	0.0,	"Arctier", "Arctiere",	null,	0.6,	1.6,	0.0,	1.0 ),
				new SkillInfo(  9, "Peacemaking",		0.0,	0.0,	0.0,	"Pacificateur", "Pacificatrice",		null,	0.0,	0.0,	0.0,	1.0 ),
				new SkillInfo( 10, "Camping",			20.0,	15.0,	15.0,	"Explorateur", "Exploratrice",	null,	2.0,	1.5,	1.5,	1.0 ),
				new SkillInfo( 11, "Carpentry",			20.0,	5.0,	0.0,	"Charpentier", "Charpentiere",	null,	2.0,	0.5,	0.0,	1.0 ),
				new SkillInfo( 12, "Cartography",		0.0,	7.5,	7.5,	"Cartographe", "Cartographe",	null,	0.0,	0.75,	0.75,	1.0 ),
				new SkillInfo( 13, "Cooking",			0.0,	20.0,	30.0,	"Cuisinier", "Cuisiniere",		null,	0.0,	2.0,	3.0,	1.0 ),
				new SkillInfo( 14, "Detecting Hidden",		0.0,	0.0,	0.0,	"Eclaireur", "Eclaireuse",	null,	0.0,	0.4,	0.6,	1.0 ),
				new SkillInfo( 15, "Discordance",		0.0,	2.5,	2.5,	"Demoralisateur", "Demolarisatrice",		null,	0.0,	0.25,	0.25,	1.0 ),
				new SkillInfo( 16, "Evaluating Intelligence",	0.0,	0.0,	0.0,	"Erudit","Erudite",	null,	0.0,	0.0,	1.0,	1.0 ),
				new SkillInfo( 17, "Healing",			6.0,	6.0,	8.0,	"Soigneur", "Soigneuse",	null,	0.6,	0.6,	0.8,	1.0 ),
				new SkillInfo( 18, "Fishing",			0.0,	0.0,	0.0,	"Pecheur", "Pecheuse",	null,	0.5,	0.5,	0.0,	1.0 ),
				new SkillInfo( 19, "Forensic Evaluation",	0.0,	0.0,	0.0,	"Detective", "Detective",	null,	0.0,	0.2,	0.8,	1.0 ),
				new SkillInfo( 20, "Herding",			16.25,	6.25,	2.5,	"Berger", "Bergere",	null,	1.625,	0.625,	0.25,	1.0 ),
				new SkillInfo( 21, "Hiding",			0.0,	0.0,	0.0,	"Ombre", "Ombre",	null,	0.0,	0.8,	0.2,	1.0 ),
				new SkillInfo( 22, "Provocation",		0.0,	4.5,	0.5,	"Provocateur", "Provocatrice",		null,	0.0,	0.45,	0.05,	1.0 ),
				new SkillInfo( 23, "Inscription",		0.0,	2.0,	8.0,	"Scribe", "Scribe",	null,	0.0,	0.2,	0.8,	1.0 ),
				new SkillInfo( 24, "Lockpicking",		0.0,	25.0,	0.0,	"Serrurier",	"Serruriere",null,	0.0,	2.0,	0.0,	1.0 ),
				new SkillInfo( 25, "Magery",			0.0,	0.0,	15.0,	"Mage", "Mage",		null,	0.0,	0.0,	1.5,	1.0 ),
				new SkillInfo( 26, "Resisting Spells",		0.0,	0.0,	0.0, "Sorcier", "Sorciere",		null,	0.25,	0.25,	0.5,	1.0 ),
				new SkillInfo( 27, "Tactics",			0.0,	0.0,	0.0,	"Tacticien", "Tacticienne",	null,	0.0,	0.0,	0.0,	1.0 ),
				new SkillInfo( 28, "Snooping",			0.0,	25.0,	0.0,	"Espion", "Espionne",	null,	0.0,	2.5,	0.0,	1.0 ),
				new SkillInfo( 29, "Musicianship",		0.0,	0.0,	0.0,	"Barde", "Barde",		null,	0.0,	0.8,	0.2,	1.0 ),
				new SkillInfo( 30, "Poisoning",			0.0,	4.0,	16.0,	"Assassin", "Assassine",	null,	0.0,	0.4,	1.6,	1.0 ),
				new SkillInfo( 31, "Archery",			2.5,	7.5,	0.0,	"Archer", "Archere",	null,	0.25,	0.75,	0.0,	1.0 ),
				new SkillInfo( 32, "Spirit Speak",		0.0,	0.0,	0.0,	"Voyant", "Voyante",	null,	0.0,	0.0,	1.0,	1.0 ),
				new SkillInfo( 33, "Stealing",			0.0,	10.0,	0.0,	"Roublard", "Roublarde",	null,	0.0,	1.0,	0.0,	1.0 ),
				new SkillInfo( 34, "Tailoring",			3.75,	16.25,	5.0,	"Couturier", "Couturiere",	null,	0.38,	1.63,	0.5,	1.0 ),
				new SkillInfo( 35, "Animal Taming",		14.0,	2.0,	4.0,	"Animalier", "Animaliere",	null,	1.4,	0.2,	0.4,	1.0 ),
				new SkillInfo( 36, "Taste Identification",	0.0,	0.0,	0.0,	"Gouteur", "Gouteuse",		null,	0.2,	0.0,	0.8,	1.0 ),
				new SkillInfo( 37, "Tinkering",			5.0,	2.0,	3.0,	"Bricoleur", "Bricoleuse",	null,	0.5,	0.2,	0.3,	1.0 ),
				new SkillInfo( 38, "Tracking",			0.0,	12.5,	12.5,	"Pisteur", "Pisteuse",	null,	0.0,	1.25,	1.25,	1.0 ),
				new SkillInfo( 39, "Veterinary",		8.0,	4.0,	8.0,	"Veterinaire", "Veterinaire",	null,	0.8,	0.4,	0.8,	1.0 ),
				new SkillInfo( 40, "Swordsmanship",		7.5,	2.5,	0.0,	"Epeiste", "Epeiste"	,null,	0.75,	0.25,	0.0,	1.0 ),
				new SkillInfo( 41, "Mace Fighting",		9.0,	1.0,	0.0,	"Mercenaire", "Mercenaire",	null,	0.9,	0.1,	0.0,	1.0 ),
				new SkillInfo( 42, "Fencing",			4.5,	5.5,	0.0,	"Escrimeur", "Escrimeuse", 	null,	0.45,	0.55,	0.0,	1.0 ),
				new SkillInfo( 43, "Wrestling",			9.0,	1.0,	0.0,	"Lutteur",	"Lutteuse", null,	0.9,	0.1,	0.0,	1.0 ),
				new SkillInfo( 44, "Lumberjacking",		20.0,	0.0,	0.0,	"Bucheron", "Bucheronne",	null,	2.0,	0.0,	0.0,	1.0 ),
				new SkillInfo( 45, "Mining",			20.0,	0.0,	0.0,	"Mineur", "Mineuse",	null,	2.0,	0.0,	0.0,	1.0 ),
				new SkillInfo( 46, "Meditation",		0.0,	0.0,	0.0,	"Sage", "Sage",	null,	0.0,	0.0,	0.0,	1.0 ),
				new SkillInfo( 47, "Stealth",			0.0,	0.0,	0.0,	"Rogue", "Rogue",	null,	0.0,	0.0,	0.0,	1.0 ),
				new SkillInfo( 48, "Remove Trap",		0.0,	0.0,	0.0,	"Trappeur", "Trappeuse",	null,	0.0,	0.0,	0.0,	1.0 ),
				new SkillInfo( 49, "Necromancy",		0.0,	0.0,	0.0,	"Necromancien", "Necromancienne",	null,	0.0,	0.0,	0.0,	1.0 ),
				new SkillInfo( 50, "Focus",			0.0,	0.0,	0.0,	"Athlete", "Athlete",	null,	0.0,	0.0,	0.0,	1.0 ),
				new SkillInfo( 51, "Chivalry",			0.0,	0.0,	0.0,	"Paladin", "Paladine",	null,	0.0,	0.0,	0.0,	1.0 ),
				new SkillInfo( 52, "Bushido",			0.0,	0.0,	0.0,	"Protecteur", "Protectrice",	null,	0.0,	0.0,	0.0,	1.0 ),
				new SkillInfo( 53, "Ninjitsu",			0.0,	0.0,	0.0,	"Assassin", "Assassine",	null,	0.0,	0.0,	0.0,	1.0 ),
				new SkillInfo( 54, "Spellweaving",		0.0,	0.0,	0.0,	"Arcaniste", "Arcaniste",	null,	0.0,	0.0,	0.0,	1.0 ),
				new SkillInfo( 55, "Mysticism",			0.0,	0.0,	0.0,	"Mystique", "Mystique",	null,	0.0,	0.0,	0.0,	1.0 ),
				new SkillInfo( 56, "Imbuing",			0.0,	0.0,	0.0,	"Artificier", "Artificiere",	null,	0.0,	0.0,	0.0,	1.0 ),
				new SkillInfo( 57, "Throwing",			0.0,	0.0,	0.0,	"Lanceur de couteaux", "Lanceuse de couteaux",	null,	0.0,	0.0,	0.0,	1.0 ),
			};
