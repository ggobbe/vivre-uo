...
namespace Server.Network
{
	...
	public class NetState : IComparable<NetState> {
        ...
        //Plume : Net 4
        public static SocketAsyncEventArgsPool m_SocketAsyncReceiveEventPool = new SocketAsyncEventArgsPool(100);
		public static SocketAsyncEventArgsPool m_SocketAsyncSendEventPool = new SocketAsyncEventArgsPool(100);
#else
        ...
        m_ReceiveEventArgs = m_SocketAsyncReceiveEventPool.Pop();
			...
			m_SendEventArgs = m_SocketAsyncSendEventPool.Pop();
        ...
        public virtual void Dispose(bool flush)
        {
			...
			m_ReceiveEventArgs.Completed -= new EventHandler<SocketAsyncEventArgs>(Receive_Completion);
			m_SendEventArgs.Completed -= new EventHandler<SocketAsyncEventArgs>(Send_Completion);
			m_SocketAsyncReceiveEventPool.Push(m_ReceiveEventArgs);
			m_SocketAsyncSendEventPool.Push(m_SendEventArgs);
            m_Socket = null;
...
//#if NewAsyncSockets
        ...
        //Plume : Net 4
        public virtual void ReadAddress()
		{
			try {
				m_Address = Utility.Intern( ( ( IPEndPoint ) m_Socket.RemoteEndPoint ).Address );
				m_ToString = m_Address.ToString();
