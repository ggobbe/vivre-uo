...
namespace Server.Mobiles
{
    public class PremiumSpawner : Item
    {
        ...
        [Constructable]
        public PremiumSpawner(int amount, int subamountA, int subamountB, int subamountC, int subamountD, int subamountE, int spawnid, int minDelay, int maxDelay, int team, int homeRange, int walkingRange, string creatureName, string creatureNameA, string creatureNameB, string creatureNameC, string creatureNameD, string creatureNameE)
            : base(0x1f13)
        {
        ...
        [Constructable]
        public PremiumSpawner(string creatureName)
            : base(0x1f13)
        {
            List<string> creaturesName = new List<string>();
            creaturesName.Add(creatureName);
        ...
        public PremiumSpawner(Serial serial)
            : base(serial)
        {
        }
        ...
        private class InternalTimer : Timer
        {
            ...
            public InternalTimer(PremiumSpawner spawner, TimeSpan delay)
                : base(delay)
            {
