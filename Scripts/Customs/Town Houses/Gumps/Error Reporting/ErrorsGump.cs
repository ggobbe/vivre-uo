...
namespace Knives.TownHouses
{
	public class ErrorsGump : GumpPlusLight
	{
		...
		protected override void BuildGump()
		{
            ...
            AddHtml(0, y, width, "<CENTER>Erreur TownHouse");
            AddImage(width / 2 - 100, y + 2, 0x39);
            AddImage(width / 2 + 70, y + 2, 0x3B);

            AddButton(width - 20, y, 0x5689, 0x5689, "Aide", new GumpCallback(Help));
		...
		{
			NewGump();
			new InfoGump( Owner, 300, 300, HTML.White + "   Erreurs signalées soit par le système maison de ville ou autres membres du personnel! Les admin ont le pouvoir d'effacer cette liste. Tous les membres du staff peuvent signaler une erreur en utilisant la commande .TownHouseErrors.", true );
		}
