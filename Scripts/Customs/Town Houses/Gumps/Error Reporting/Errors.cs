...
namespace Knives.TownHouses
{
	public class Errors
	{
		...
		{
            RUOVersion.AddCommand("Erreure TownHouse", AccessLevel.Counselor, new TownHouseCommandHandler(OnErrors));
            RUOVersion.AddCommand("le", AccessLevel.Counselor, new TownHouseCommandHandler(OnErrors));
