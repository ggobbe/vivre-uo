...
namespace Server.SkillHandlers
{
	public class Tracking
	{
		...
		{
			m.SendMessage( "Que désirez-vous traquer?" ); // What do you wish to track?
	...
	public class TrackWhatGump : Gump
	{
		...
		public TrackWhatGump( Mobile from ) : base( 20, 30 )
		{
			...
			AddHtml( 20, 90, 100, 20, "Animaux", false, false ); // Animals

			AddItem( 120, 20, 9607 );
			AddButton( 120, 110, 4005, 4007, 2, GumpButtonType.Reply, 0 );
			AddHtml( 120, 90, 100, 20, "Monstres", false, false ); // Monsters

			AddItem( 220, 20, 8454 );
			AddButton( 220, 110, 4005, 4007, 3, GumpButtonType.Reply, 0 );
			AddHtml( 220, 90, 100, 20, "PNJs Humains", false, false ); // Human NPCs

			AddItem( 320, 20, 8455 );
			AddButton( 320, 110, 4005, 4007, 4, GumpButtonType.Reply, 0 );
			AddHtml( 320, 90, 100, 20, "Joueurs", false, false ); // Players
		}
