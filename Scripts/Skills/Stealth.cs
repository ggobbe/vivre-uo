...
namespace Server.SkillHandlers
{
	public class Stealth
	{
		...
		public static TimeSpan OnUse( Mobile m )
		{
			...
			{
                 int difficulty = GetDifficulty(m);
                ...
                else if ((m.CheckSkill(SkillName.Stealth, -20.0 + (armorRating * 2), (Core.AOS ? 60.0 : 80.0) + (armorRating * 2))) && ((m.Skills[SkillName.Stealth].Value - difficulty) > Utility.Random(0, (int)m.Skills[SkillName.Stealth].Value)))
				{
