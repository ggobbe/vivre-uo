...
namespace Server.Items
{
	public abstract class BaseHides : Item, ICommodity
	{
        ...
        public BaseHides(CraftResource resource, int amount, int hue)
            : base(0x1079)
        {
            Stackable = true;
            Weight = 5.0;
	...
	public class SpinedHides : BaseHides, IScissorable
	{
        ...
        [Constructable]
        public SpinedHides(int amount, int hue)
            : base(CraftResource.SpinedLeather, amount, hue)
        {
	...
	public class HornedHides : BaseHides, IScissorable
	{
        ...
        [Constructable]
        public HornedHides(int amount, int hue)
            : base(CraftResource.HornedLeather, amount, hue)
        {
        }
	...
	public class BarbedHides : BaseHides, IScissorable
	{
        ...
        [Constructable]
        public BarbedHides(int amount, int hue)
    ...
    //viking : ajout des hides pour le Daemon
    [FlipableAttribute(0x1079, 0x1078)]
    public class DaemonHides : BaseHides, IScissorable
    {
        [Constructable]
        public DaemonHides() : this(1)
        {
        }

        [Constructable]
        public DaemonHides(int amount) : base(CraftResource.DaemonLeather, amount)
        {
        }
