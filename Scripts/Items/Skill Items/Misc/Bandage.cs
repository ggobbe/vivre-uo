...
namespace Server.Items
{
	...
	public class BandageContext
	{
		...
		public void EndHeal()
		{
            ...
            // Scriptiz : ajout pour le bloody bandage system
					...
					else
					{
						...
						if ( petPatient != null && petPatient.IsDeadPet )
						{
							...
							if( master != null && m_Healer == master )
							{
                                ...
                                int Penalty = petPatient.CalculatePenalty(m_Healer);

								for ( int i = 0; i < Penalty ; ++i )
								{
                                    petPatient.Skills[Utility.RandomList(1,16,25,26,27,30,43,46)].Base -= 0.1;
								}
							}
