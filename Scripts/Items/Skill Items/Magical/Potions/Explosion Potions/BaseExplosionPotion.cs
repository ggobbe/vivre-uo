...
namespace Server.Items
{
	public abstract class BaseExplosionPotion : BasePotion
	{
		...
		public void Explode( Mobile from, bool direct, Point3D loc, Map map )
		{
			...
			{
            //Plume : Les joueurs peuvent se blesser
                if (o is Mobile && (from == null || (((Mobile)o).AccessLevel <= from.AccessLevel && from.CanBeHarmful((Mobile)o, false))))
				{
					toExplode.Add( o );
					++toDamage;
				}
