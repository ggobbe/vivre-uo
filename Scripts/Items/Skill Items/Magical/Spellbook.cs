...
namespace Server.Items
{
	...
	public class Spellbook : Item, ICraftable, ISlayer
	{
		...
		public static List<Spellbook> FindAllSpellbooks( Mobile from )
		{
            ...
            // Scriptiz : s'il y a un livre équipé, le sort doit venir de ce livre et pas d'un autre dans le sac !
            // Scriptiz edit 24/04/12 : on retire les modifs dégueu
            //if (list.Count > 0 && ((Spellbook)item).SpellbookType == SpellbookType.Regular) 
            //    return list;
            // Scriptiz : cette méthode doit retourner tous les spellbooks, pas bien de l'altérer :p
        ...
        public override bool AllowSecureTrade(Mobile from, Mobile to, Mobile newOwner, bool accepted)
        {
            ...
            /* Scriptiz : plus besoin de ne pas pouvoir équiper un livre si on on possède plusieurs */
            //if (this.SpellbookType == SpellbookType.Regular)
            //{
            //    Item item = to.FindItemOnLayer(Layer.OneHanded);
            //    if (item is Spellbook && ((Spellbook)item).SpellbookType == SpellbookType.Regular)
            //    {
            //        to.PlaceInBackpack(item);
            //        to.SendMessage("Vous posez votre livre dans votre sac");
            //    }
            //}
        ...
        //            from.SendMessage("Vous posez votre livre dans votre sac");
        //        }
        //    }
        //    return base.DropToItem(from, target, p);
        //}
		...
		public override bool CanEquip( Mobile from )
		{
            ...
            //    return true;
            //else if (this.SpellbookType == SpellbookType.Regular)
            //{
            //    Container c = from.Backpack;
            //    if (c == null)
            //        return base.CanEquip(from);
            //    int count = 0;
            //    Item[] found = c.FindItemsByType(typeof(Spellbook), true);

            //    for (int i = 0; i < found.Length; ++i)
            //    {
            //        Spellbook book = (Spellbook)found[i];
            ...
            //    if (count > 0)
            //    {
            //        from.SendMessage("Vous ne pouvez équiper un livre en en tenant autant dans votre sac");
            //        return false;
            //    }
            //}
