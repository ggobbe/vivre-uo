...
namespace Server.Items
{
    public enum DecorateCommand
    {
        ...
        Up,
        Down,
        // Scriptiz : on ajoute des flèches pour faire glisser
        West,
        North,
        East,
        South
    ...
    public class InteriorDecorator : Item
    {
        ...
        public override void GetProperties(ObjectPropertyList list)
        {
            ...
            // Scriptiz :  Source de problèmes à cause des nouvelles commandes
        ...
        private class InternalTarget : Target
        {
            ...
            protected override void OnTarget(Mobile from, object targeted)
            {
                if (targeted is Item && InteriorDecorator.CheckUse(m_Decorator, from))
                {
                    ...
                    // Scriptiz : on peut déplacer même des objets lourds
            ...
            // Scriptiz : ajout d'une méthode pour déplacer un objet dans une maison
            private static void Move(Item item, Mobile from, Direction dir)
            {
                ...
                else from.SendMessage("Vous ne pouvez pas déplacer cet objet en dehors de la maison.");
            }
