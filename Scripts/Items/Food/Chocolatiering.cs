...
namespace Server.Items
{
    ...
    public class DarkChocolate : BaseCandyCane
	{
    ...
    public class MilkChocolate : BaseCandyCane
	{
		...
		public MilkChocolate()
			: base( 0xF18 )
		{
            Name = "Carreau de chocolat au lait";
			Hue = 0x461;
			LootType = LootType.Regular;
		}
    ...
    public class WhiteChocolate : BaseCandyCane
	{
		...
		public WhiteChocolate()
			: base( 0xF11 )
		{
            Name = "Carreau de chocolat blanc";
			Hue = 0x47E;
			LootType = LootType.Regular;
		}
