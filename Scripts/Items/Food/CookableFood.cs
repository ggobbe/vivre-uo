...
namespace Server.Items
{
		...
		private class InternalTarget : Target
		{
			...
			private class InternalTimer : Timer
			{
				...
				protected override void OnTick()
				{
					...
					{
                        m_From.SendMessage("Vous avez calciné votre nourriture!"); // You burn the food to a crisp! It's ruined.
						return;
					}
	...
	public class RawRibs : CookableFood
	{
        ...
        {
            if (Amount > 1)
                list.Add("{0} Côtelettes crues", Amount);
            else
                list.Add("{0} Cotelette crue", Amount);
        }
	...
	public class RawLambLeg : CookableFood
	{
        ...
        {
            if (Amount > 1)
                list.Add("{0} Gigots d'agneau crus", Amount);
            else
                list.Add("{0} Gigot d'agneau cru", Amount);
        }
	...
	public class RawChickenLeg : CookableFood
	{
        ...
        {
            if (Amount > 1)
                list.Add("{0} Cuisses de poulet crues", Amount);
            else
                list.Add("{0} Cuisse de poulet crue", Amount);
        }
	...
	public class RawBird : CookableFood
	{
        ...
        {
            if (Amount > 1)
                list.Add("{0} Oiseaux crus", Amount);
            else
                list.Add("{0} Oiseau cru", Amount);
        }
	...
	public class UnbakedPumpkinPie : CookableFood
	{
		...
		{
            Name = "Tarte à la citrouille crue";
			Weight = 1.0;
		}
	...
	public class Eggs : CookableFood
	{
        ...
        {
            if (Amount > 1)
                list.Add("{0} Oeufs crus", Amount);
            else
                list.Add("{0} Oeuf cru", Amount);
        }
	...
	public class RawFishSteak : CookableFood
	{
        ...
        {
            if (Amount > 1)
                list.Add("{0} Filets de poisson cru", Amount);
            else
                list.Add("{0} Filet de poisson cru", Amount);
        }
