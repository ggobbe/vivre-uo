...
namespace Server.Items
{
	...
	public class Dough : Item
	{
        ...
        {
            if (Amount > 1)
                list.Add("{0} Pâtes", Amount);
            else
                list.Add("{0} Pâte", Amount);
        }
	...
	public class SweetDough : Item
	{
        ...
        {
            if (Amount > 1)
                list.Add("{0} Pâtes sucrées", Amount);
            else
                list.Add("{0} Pâte sucrée", Amount);
        }
	...
	public class JarHoney : Item
	{
        ...
        {
            if (Amount > 1)
                list.Add("{0} pot de miel", Amount);
            else
                list.Add("{0} pots de miel", Amount);
        }
	...
	public class WheatSheaf : Item
	{
        ...
        {
            if (Amount > 1)
                list.Add("{0} Gerbes de blé", Amount);
            else
                list.Add("{0} Gerbe de blé", Amount);
        }
