...
namespace Server.Items
{
	public abstract class Food : Item
	{
        ...
        public override void AddNameProperty(ObjectPropertyList list)
        {
            if (Amount > 1)
            {
                ...
                else if (Name == "Régime de bananes")
                    list.Add("{0} Régimes de bananes", Amount);
                ...
                else if (Name == "Épi de maïs")
                    list.Add("{0} Épis de maïs", Amount);
                else if (Name == "Gerbe de blé")
	...
	public class PumpkinPie : Food
	{
		...
		{
            this.Name = "Tarte à la citrouille";
            Stackable = false;
			this.Weight = 1.0;
			this.FillFactor = 5;
		}
