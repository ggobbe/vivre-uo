...
namespace Server.Regions
{
    ...
    {
        #region Scriptiz : gestion des saisons
        private Season m_Season = Season.Summer;
        public virtual Season Season { get { return m_Season; } set { m_Season = value; UpdateSeason(); } }
        ...
        {
            UpdateSeason(m, (int)m_Season);
        }

        private void UpdateSeason(Mobile m, int s)
        {
            if (s < 0 || s > 4) return;
