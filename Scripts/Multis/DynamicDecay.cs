...
namespace Server.Multis
{
	public class DynamicDecay
	{
		...
		static DynamicDecay()
		{
            ...
            // Scriptiz : on augmente le temps pour tourner vers 31 jours !
            Register(DecayLevel.LikeNew, TimeSpan.FromDays(1), TimeSpan.FromDays(2));
            Register(DecayLevel.Slightly, TimeSpan.FromDays(7), TimeSpan.FromDays(8));
            Register(DecayLevel.Somewhat, TimeSpan.FromDays(7), TimeSpan.FromDays(8));
            Register(DecayLevel.Fairly, TimeSpan.FromDays(7), TimeSpan.FromDays(8));
            Register(DecayLevel.Greatly, TimeSpan.FromDays(7), TimeSpan.FromDays(8));
            Register(DecayLevel.IDOC, TimeSpan.FromDays(2), TimeSpan.FromDays(3));
