...
namespace Server.Mobiles
{
	public class CustomHairstylist : BaseVendor
	{
        ...
        private static HairstylistBuyInfo[] m_SellList = new HairstylistBuyInfo[]
			{
				new HairstylistBuyInfo( "Coupe de cheveux (250 pièces)", 250, false, typeof( ChangeHairstyleGump ),
					new object[] { From, Vendor, Price, false, ChangeHairstyleEntry.HairEntries } ),
				new HairstylistBuyInfo( "Rasage de la barbe (250 pièces)" , 250, true, typeof( ChangeHairstyleGump ), 
					new object[] { From, Vendor, Price, true, ChangeHairstyleEntry.BeardEntries } ),
				new HairstylistBuyInfo( "Coloration normale (50 pièces)", 50, false, typeof( ChangeHairHueGump ), 
					new object[] { From, Vendor, Price, true, true, ChangeHairHueEntry.RegularEntries } ),
				new HairstylistBuyInfo( "Coloration brillante (50000 pièces)", 50000, false, typeof( ChangeHairHueGump ),
					new object[] { From, Vendor, Price, true, true, ChangeHairHueEntry.BrightEntries } ),
				new HairstylistBuyInfo( "Coloration normale des cheveux uniquement (375 pièces)", 375, false, typeof( ChangeHairHueGump ), 
					new object[] { From, Vendor, Price, true, false, ChangeHairHueEntry.RegularEntries } ),
				new HairstylistBuyInfo( "Coloration normale de la barbe uniquement (375 pièces)", 375, true, typeof( ChangeHairHueGump ), 
					new object[] { From, Vendor, Price, false, true, ChangeHairHueEntry.RegularEntries } ),
				new HairstylistBuyInfo( "Coloration brillante des cheveux uniquement (75000 pièces)", 75000, false, typeof( ChangeHairHueGump ), 
					new object[] { From, Vendor, Price, true, false, ChangeHairHueEntry.BrightEntries } ),
				new HairstylistBuyInfo( "Coloration brillante de la barbe uniquement (75000 pièces)", 75000, true, typeof( ChangeHairHueGump ), 
					new object[] { From, Vendor, Price, false, true, ChangeHairHueEntry.BrightEntries } )
			};
		...
		[Constructable]
		public CustomHairstylist() : base( "le Coiffeur", "la Coiffeuse" )
		{
		}
		...
		public static readonly ChangeHairstyleEntry[] HairEntries = new ChangeHairstyleEntry[]
			{
				...
				new ChangeHairstyleEntry( 60902, 193 - 260, 140 - 190, 0x2049 ),
	...
	public class ChangeHairstyleGump : Gump
	{
		...
		public override void OnResponse( NetState sender, RelayInfo info )
		{
			...
			if ( m_From.Race == Race.Elf || m_From.IsElfBody ) // Scriptiz : "|| IsElfBody" pour l'apparence elfique
			{
