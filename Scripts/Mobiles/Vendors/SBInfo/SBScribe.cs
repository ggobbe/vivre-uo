	...
	public class SBScribe: SBInfo
	{
		...
		public class InternalBuyInfo : List<GenericBuyInfo>
		{
			public InternalBuyInfo()
			{
				...
				Add( new GenericBuyInfo( typeof( BrownBook ), 35, 10, 0xFEF, 0 ) );
                Add(new GenericBuyInfo(typeof(TanBook), 35, 10, 0xFF0, 0));
                Add(new GenericBuyInfo(typeof(BlueBook), 35, 10, 0xFF2, 0));
		...
		public class InternalSellInfo : GenericSellInfo
		{
			public InternalSellInfo()
			{
				...
				Add( typeof( BlankScroll ), 5 );    // Scriptiz 3
			}
		}
	}
}