	...
	public class SBProvisioner : SBInfo
	{
		...
		public class InternalBuyInfo : List<GenericBuyInfo>
		{
			public InternalBuyInfo()
			{
                ...
                Add(new GenericBuyInfo(typeof(RedBook), 35, 20, 0xFF1, 0));
                Add(new GenericBuyInfo(typeof(BlueBook), 35, 20, 0xFF2, 0));
                Add(new GenericBuyInfo(typeof(TanBook), 35, 20, 0xFF0, 0));
