...
namespace Server.Mobiles
{
	public class BaseEscortable : BaseCreature
	{
		...
		public virtual void InitOutfit()
		{
			...
			//PackGold(200, 250);
            PackGold(5, 25);   // Scriptiz : pour éviter le farm des base escortables pour se faire de l'or
		}
		...
		public virtual bool CheckAtDestination()
		{
			...
			{
				Say("Nous sommes arrivés, je vous remercie {0}! Je n'ai plus besoin de vos services désormais. Voici votre or", escorter.Name); // We have arrived! I thank thee, ~1_PLAYER_NAME~! I have no further need of thy services. Here is thy pay.
