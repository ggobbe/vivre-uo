...
namespace Server.Mobiles
{
	public class Banker : BaseVendor
	{
		...
		[Constructable]
		public Banker() : base( "le Banquier", "la Banquiere" )
		{
		}
		...
		{
			if ( from.InRange( this.Location, 12 ) && from.InLOS(this) )    // Scriptiz : && from.InLOS(this) (ligne de vue)
				return true;
				...
				for ( int i = 0; i < e.Keywords.Length; ++i )
				{
					...
					switch ( keyword )
					{
						...
						case 0x0002: // *bank*
						{
                            ...
                            if (e.Speech.Split(' ').Length <= 3)
                                this.Say("Un petit peu de politesse s'il vous plait quand vous quémandez votre coffre !");
                            else
