...
// end 1st
          AI_None,
        AI_Pomi,
        // Myron : AI pour gardes PNJ
        AI_VivreGuard,
        //Vinds : AI pour assassins paranos. très perfectible, mais a tester en réel.
        AI_Assassin
	}
...
// end 2nd
		...
		public virtual bool AcquireFocusMob( int iRange, FightMode acqType, bool bPlayerOnly, bool bFacFriend, bool bFacFoe )
		{
			...
			if( map != null )
			{
                ...
                // Scriptiz: this doesn't work so I'll keep the old version above
