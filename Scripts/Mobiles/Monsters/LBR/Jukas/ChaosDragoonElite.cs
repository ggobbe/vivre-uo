...
namespace Server.Mobiles
{
	...
	public class ChaosDragoonElite : BaseCreature
	{
			...
			: base(AIType.AI_Mage, FightMode.Closest, 10, 1, 0.15, 0.4)
		{
			...
			{
				case 0: res = CraftResource.MDullcopper; break;
				case 1: res = CraftResource.MShadow; break;
				case 2: res = CraftResource.MCopper; break;
				case 3: res = CraftResource.MBronze; break;
				case 4: res = CraftResource.MGold; break;
				case 5: res = CraftResource.MAgapite; break;
				case 6: res = CraftResource.MVerite; break;
				case 7: res = CraftResource.MValorite; break;
				case 8: res = CraftResource.MIron; break;
			}
