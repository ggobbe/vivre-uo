...
namespace Server.Mobiles
{
	...
	public class AntLion : BaseCreature
	{
		...
		public AntLion() : base( AIType.AI_Melee, FightMode.Closest, 10, 1, 0.2, 0.4 )
		{
			...
			PackItem( new Bone( 3 ) );
			PackItem( new FertileDirt( Utility.RandomMinMax( 1, 10 ) ) );    // Scriptiz : par défaut de 1 à 5
			...
			switch (Utility.Random(4))
			{
				...
				case 1: orepile = new ShadowOre(); break;
				case 2: orepile = new CopperOre(); break;
				default: orepile = new BronzeOre(); break;
			}
			orepile.Amount = Utility.RandomMinMax(1, 5);   // Scriptiz : par défaut de 1 à 10
		...
		{
			AddLoot( LootPack.Average, 1 ); // Scriptiz : par défaut 2
		}
