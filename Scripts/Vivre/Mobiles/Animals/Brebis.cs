...
{
	[CorpseName( "Un corps de brebis" )]
	public class Brebis : BaseCreature, ICarvable
	{
		...
		public void Carve( Mobile from, Item item )
		{
			if ( DateTime.Now < m_NextWoolTime )
			{
				...
				PrivateOverheadMessage( MessageType.Regular, 0x3B2, false, "Cette brebis n'est pas prête pour la tonte", from.NetState );
				return;
			}

			from.SendMessage( "Vous placez la laine tondue dans votre sac" ); // You place the gathered wool into your backpack.
		...
		[Constructable]
		public Brebis() : base( AIType.AI_Animal, FightMode.Aggressor, 10, 1, 0.2, 0.4 )
		{
			Name = "Une brebis";
			Body = 0xCF;
			BaseSoundID = 0xD6;
        ...
        public Brebis(Serial serial)    : base(serial)
		{
		}
