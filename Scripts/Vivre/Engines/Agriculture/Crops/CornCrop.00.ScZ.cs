...
namespace Server.Items.Crops
{
    ...
    public class CornSeedling : BaseCrop
    {
        ...
        [Constructable]
        public CornSeedling(Mobile sower)
            : base(0xCB5)
        {
            Movable = false;
            Name = AgriTxt.Seedling + " de maïs";
            m_sower = sower;
        ...
        public CornSeedling(Serial serial)
            : base(serial)
        {
        }
    ...
    public class CornCrop : BaseCrop
    {
            ...
            if (DateTime.Now > lastpicked.AddSeconds(3)) // 3 seconds between picking
            {
                ...
                if (from.InRange(this.GetWorldLocation(), 2))
                {
                    ...
                    else //check skill and sower
                    {
                        ...
                        m_yield -= pick;
                        from.SendMessage(AgriTxt.YouPick + " {0} épi{1} de maïs!", pick, (pick == 1 ? "" : "s"));
        ...
        private class CropTimer : Timer
        {
            ...
            public CropTimer(CornCrop plant)
