...
namespace Server.Items.Crops
{
    ...
    public class GarlicSeedling : BaseCrop
    {
        ...
        [Constructable]
        public GarlicSeedling(Mobile sower)
            : base(0xC68)
        {
            Movable = false;
            Name = AgriTxt.Seedling + " d'ail";
            m_sower = sower;
    ...
    public class GarlicCrop : BaseCrop
    {
        ...
        [Constructable]
        public GarlicCrop(Mobile sower)
            : base(0xC69)
        {
            Movable = false;
            Name = "Gousse d'ail";
        ...
        {
            private GarlicCrop i_plant;

            public CropTimer(GarlicCrop plant)
