...
namespace Server.Items.Crops
{
    ...
    public class WheatSeedling : BaseCrop
    {
        ...
        [Constructable]
        public WheatSeedling(Mobile sower)
            : base(Utility.RandomList(0xDAE, 0xDAF))
        {
            Movable = false;
            Name = AgriTxt.Seedling + " de blé";
            m_sower = sower;
        ...
        public WheatSeedling(Serial serial)
            : base(serial)
        {
        }
    ...
    public class WheatCrop : BaseCrop
    {
        ...
        public WheatCrop(Mobile sower)
            : base(Utility.RandomList(0xC55, 0xC56))
        {
            Movable = false;
            Name = "Blé";
        ...
        private class CropTimer : Timer
        {
            ...
            public CropTimer(WheatCrop plant)
