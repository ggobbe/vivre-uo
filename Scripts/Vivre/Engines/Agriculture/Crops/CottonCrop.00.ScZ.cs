...
{ 
	...
	{ 
		...
		{ 
			Movable = false; 
			Name = AgriTxt.Seedling + " de Coton"; 
			m_sower = sower;
	...
	{ 
		...
		public static void init ( CottonCrop plant, bool full )
		{
			plant.PickGraphic = Utility.RandomList( 0xC53, 0xC54 );
			plant.FullGraphic = Utility.RandomList( 0xC4F, 0xC50 );
		...
		{
			private CottonCrop i_plant;

			public CropTimer( CottonCrop plant ) : base( TimeSpan.FromSeconds( 600 ), TimeSpan.FromSeconds( 15 ) )
			{
