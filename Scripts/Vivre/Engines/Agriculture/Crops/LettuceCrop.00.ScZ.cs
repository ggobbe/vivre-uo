...
namespace Server.Items.Crops
{
    ...
    public class LettuceSeedling : BaseCrop
    {
        ...
        [Constructable]
        public LettuceSeedling(Mobile sower)
            : base(0xCB5)
        {
            Movable = false;
            Name = AgriTxt.Seedling + " de laitue";
            m_sower = sower;
        ...
        public LettuceSeedling(Serial serial)
            : base(serial)
        {
        }
    ...
    public class LettuceCrop : BaseCrop
    {
        ...
        private class CropTimer : Timer
        {
            ...
            public CropTimer(LettuceCrop plant)
