...
namespace Server.Items.Crops
{
	...
	//naga
		public class KatylSeed : BaseCrop 
		{ 
		...
		[Constructable]
		public KatylSeed() : this( 1 )
		{
		}

		[Constructable]
		public KatylSeed( int amount ) : base( 0xF27 )
		{
			Stackable = true; 
			Weight = .5; 
			Hue = 0x5E1; 
		...
		{ 
			...
			this.Consume(); 
			Item item = new KatylSapling();// from ); 
			item.Location = m_pnt; 
			item.Map = m_map; 
			
		} 

		public KatylSeed( Serial serial ) : base( serial ) 
		{ 
		} 
	...
	public class KatylSapling : BaseCrop 
	{ 
		...
		[Constructable] 
		public KatylSapling() : base( Utility.RandomList ( 0xCA6, 0xCA6 ) ) 
		{ 
			Movable = false;
            Name = AgriTxt.Seedling + " de Katyliis"; 
			
			init( this );
		} 

		public static void init( KatylSapling plant )
		{
			TimeSpan delay = TreeHelper.SaplingTime;
			plant.treeTime = DateTime.Now + delay;

			plant.thisTimer = new TreeHelper.TreeTimer( plant, typeof(KatylTree), delay ); 
			plant.thisTimer.Start(); 
		}

		public KatylSapling( Serial serial ) : base( serial ) 
		{ 
		} 
	...
	public class KatylTree : BaseTree
	{
		public Item i_trunk;
		...
		[Constructable] 
		public KatylTree( Point3D pnt, Map map ) : base( Utility.RandomList( 0xD37, 0xD38 ) ) // leaves
		{
			Movable = false;
			MoveToWorld( pnt, map );
            Name = "Katyliis";
		...
		public KatylTree( Serial serial ) : base( serial )
		{
		}
