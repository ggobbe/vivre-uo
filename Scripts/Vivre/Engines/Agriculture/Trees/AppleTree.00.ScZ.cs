...
{
    //naga
    public class AppleSeed : BaseCrop
    {
        ...
        public AppleSeed(Serial serial)
            : base(serial)
        {
        }
    ...
    public class AppleSapling : BaseCrop
    {
        ...
        {
            Movable = false;
            Name = AgriTxt.Seedling + " de Pommier";
    ...
    public class AppleTree : BaseTree
    {
        ...
        [Constructable]
        public AppleTree(Point3D pnt, Map map)
            : base(Utility.RandomList(0xD96, 0xD9A)) // leaves
        {
            Movable = false;
            MoveToWorld(pnt, map);
            ...
            if (DateTime.Now > lastpicked.AddSeconds(3)) // 3 seconds between picking
            {
                ...
                if (from.InRange(this.GetWorldLocation(), 2))
                {
                    ...
                    else //check skill
                    {
                        ...
                        m_yield -= pick;
                        from.SendMessage(AgriTxt.YouPick + " {0} pomme{1}!", pick, (pick == 1 ? "" : "s"));
        ...
        private class FruitTimer : Timer
        {
            ...
            public FruitTimer(AppleTree plant)
        ...
        private class StumpTimer : Timer
        {
            ...
            public StumpTimer(AppleTree Tree, FruitTreeStump Stump, Mobile from)
