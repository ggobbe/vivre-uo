...
namespace Server.Engines.Reports
{
	public class HtmlRenderer
	{
		...
		private HtmlRenderer( string outputDirectory )
		{
            ...
            m_OutputDirectory = Path.Combine( Core.BaseDirectory, "Reports" );
		...
		{
			BarGraphRenderer barGraph = new BarGraphRenderer( Color.Black );    // Scriptiz : Default = Color.White
            barGraph.Width = 600;
            barGraph.Height = 400;
            ...
            barGraph.FontColor = Color.FromArgb(193, 193, 193);   // Scriptiz : Default = Color.Black
