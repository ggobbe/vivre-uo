...
namespace Server.Engines.BulkOrders
{
	...
	public abstract class SmallBOD : Item
	{
		...
		public static BulkMaterialType GetMaterial( CraftResource resource )
		{
			switch ( resource )
			{
				case CraftResource.MDullcopper:		return BulkMaterialType.DullCopper;
				case CraftResource.MShadow:		return BulkMaterialType.ShadowIron;
                case CraftResource.MCopper: return BulkMaterialType.Copper;
                case CraftResource.MBronze: return BulkMaterialType.Bronze;
                case CraftResource.MGold: return BulkMaterialType.Gold;
                case CraftResource.MAgapite: return BulkMaterialType.Agapite;
                case CraftResource.MVerite: return BulkMaterialType.Verite;
                case CraftResource.MValorite: return BulkMaterialType.Valorite;
