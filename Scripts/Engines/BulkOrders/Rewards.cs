...
namespace Server.Engines.BulkOrders
{
	...
	public sealed class SmithRewardCalculator : RewardCalculator
	{
		...
		{
			if ( type >= 1 && type <= 8 )
				return new RunicHammer( CraftResource.MIron + type, Core.AOS ? ( 55 - (type*5) ) : 50 );
			...
			Groups = new RewardGroup[]
				{
					...
					new RewardGroup( 500, new RewardItem( 1, BearRug ) ),   // Scriptiz : passe de 450 à 500
					//new RewardGroup( 500, new RewardItem( 1, PowerScroll, 10 ) ),
					new RewardGroup( 650, new RewardItem( 1, ClothingBlessDeed ) ), // Scriptiz : passe de 550 à 650
