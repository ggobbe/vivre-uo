	...
	public class Fishing : HarvestSystem
	{
		...
		private Fishing()
		{
			...
			if ( Core.ML )
			{
				...
				{
					new BonusHarvestResource( 0, 98.4, null, null ), //set to same chance as mining ml gems
					new BonusHarvestResource( 70.0, 1.0, "Vous ramenez un petit sac bien étrange", typeof( CacaoBag ) ),
