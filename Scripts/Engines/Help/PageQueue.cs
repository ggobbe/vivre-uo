...
namespace Server.Engines.Help
{
	...
	public class PageQueue
	{
		...
		public static void Enqueue( PageEntry entry )
		{
            ...
            // Scriptiz : on s'en fou du speech log ici afin de quand même envoyer les pages par email
        ...
        private static void SendEmail(PageEntry entry)
        {
			...
			// Scriptiz : sujet approprié pour l'email
            mail.Subject = "RunUO " + (entry.SpeechLog != null ? "Speech Log " : "") + "Page Forwarding";
			...
			using ( StringWriter writer = new StringWriter() )
			{
                ...
                // Scriptiz : s'il s'agit d'un simple page sans speechlog on ne l'affiche pas
