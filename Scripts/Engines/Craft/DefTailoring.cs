...
namespace Server.Engines.Craft
{
	public class DefTailoring : CraftSystem
	{
		...
		public override void InitCraftList()
		{
            ...
            AddCraft(typeof(RobeACapuche), 1015269, "Robe à Capuche", 55.6, 74.3, typeof(Cloth), 1044286, 16, 1044287);
            AddCraft(typeof(JesterSuit), 1015269, 1028095, 8.2, 33.2, typeof(Cloth), 1044286, 24, 1044287);
            AddCraft(typeof(ElvenShirt), 1015269, "Chemise Exotique", 80, 110, typeof(Cloth), 1044286, 10, 1044287);
            AddCraft(typeof(ElvenDarkShirt), 1015269, "Chemise Exotique (sombre)", 80, 110, typeof(Cloth), 1044286, 10, 1044287);
            AddCraft(typeof(MaleElvenRobe), 1015269, "Robe exotique (homme)", 80, 110, typeof(Cloth), 1044286, 30, 1044287);
            AddCraft(typeof(FemaleElvenRobe), 1015269, "Robe exotique (femme)", 80, 110, typeof(Cloth), 1044286, 30, 1044287);
            ...
            AddCraft(typeof(ElvenPants), 1015279, "Pantalon exotique", 80, 110, typeof(Cloth), 1044286, 12, 1044287);
            ...
            index = AddCraft(typeof(PoupeeFemale), 1015283, "Poupée (femme)", 26.9, 80.4, typeof(Cloth), 1044286, 6, 1044287);
            AddRes(index, typeof(Cotton), "Coton", 4, "Vous n'avez pas assez de coton");

            index = AddCraft(typeof(PoupeeMale), 1015283, "Poupée (homme)", 25.9, 79.4, typeof(Cloth), 1044286, 6, 1044287);
            AddRes(index, typeof(Cotton), "Coton", 4, "Vous n'avez pas assez de coton");
            AddCraft(typeof(WoodlandBelt), 1015283, "LE Pagne", 80, 110, typeof(Cloth), 1044286, 10, 1044287);

            // Vinds : oreillers and co
            index = AddCraft(typeof(SmallPillow), 1015283, "petit coussin", 61.6, 91.6, typeof(Cloth), 1044462, 4, 1044463);
            AddRes(index, typeof(Feather), "Plumes", 30, "Il faudra un peu plus de plumes");

            index = AddCraft(typeof(Pillow), 1015283, "coussin", 63.6, 93.6, typeof(Cloth), 1044462, 6, 1044463);
            AddRes(index, typeof(Feather), "Plumes", 50, "Il vous faudra un peu plus de plumes");

            index = AddCraft(typeof(BigPillow), 1015283, "gros coussin", 66.8, 96.8, typeof(Cloth), 1044462, 8, 1044463);
            AddRes(index, typeof(Feather), "Plumes", 70, "Il vous faudra un peu plus de plumes");

            index = AddCraft(typeof(SmallDiagPillow), 1015283, "petit oreiller", 61.6, 91.6, typeof(Cloth), 1044462, 4, 1044463);
            AddRes(index, typeof(Feather), "Plumes", 30, "Il vous faudra un peu plus de plumes");

            index = AddCraft(typeof(DiagPillow), 1015283, "oreiller", 66.3, 93.6, typeof(Cloth), 1044462, 6, 1044463);
            AddRes(index, typeof(Feather), "Plumes", 50, "Il vous faudra un peu plus de plumes");

            // fin oreillers

            AddCraft(typeof(RubanCheveux), 1015283,"ruban à cheveux", 0.1, 15.0, typeof(Cloth), 1044286, 1, 1044287);
            ...
            index = AddCraft(typeof(Backpack), 1015283, "Sac", 60.5, 85.5, typeof(Cloth), 1044286, 1, 1044287);
            AddRes(index, typeof(Leather), 1044462, 3, 1044463);
            ForceNonExceptional(index);

            index = AddCraft(typeof(Bag), 1015283, "Bourse", 43.8, 67.5, typeof(Cloth), 1044286, 1, 1044287);
            AddRes(index, typeof(Leather), 1044462, 1, 1044463);
            ForceNonExceptional(index);
			#endregion
            ...
            AddCraft(typeof(ElvenBoots), 1015288, "Bottes exotiques", 80, 110, typeof(Leather), 1044462, 15, 1044463);
			#endregion
            ...
            AddCraft(typeof(LeafArms), 1015293, "Leaf Arms", 80, 110, typeof(Leather), 1044462, 15, 1044463);
            AddCraft(typeof(LeafChest), 1015293, "Leaf Chest", 80, 110, typeof(Leather), 1044462, 15, 1044463);
            AddCraft(typeof(LeafGloves), 1015293, "Leaf Gloves", 80, 110, typeof(Leather), 1044462, 15, 1044463);
            AddCraft(typeof(LeafGorget), 1015293, "Leaf Gorget", 80, 110, typeof(Leather), 1044462, 15, 1044463);
            AddCraft(typeof(LeafLegs), 1015293, "Leaf Legs", 80, 110, typeof(Leather), 1044462, 15, 1044463);
            AddCraft(typeof(LeafTonlet), 1015293, "Leaf Tonlet", 80, 110, typeof(Leather), 1044462, 12, 1044463);
			...
			if( Core.SE )
			{
				...
				SetNeededExpansion( index, Expansion.SE );
                index = AddCraft(typeof(VivreCagoule), 1015293, "Cagoule", 90.0, 100.0, typeof(Leather), 1044462, 14, 1044463);
                SetNeededExpansion(index, Expansion.SE);
			}
            ...
            AddCraft(typeof(FemaleLeafChest), 1015306, "Female Leaf Chest", 80, 110, typeof(Leather), 1044462, 15, 1044463);
			#endregion
            ...
            #region Contenant
            AddCraft(typeof(Basket), "Contenants", "Panier rudimentaire", 35.0, 60.0, typeof(WheatSheaf), "Gerbe de blé", 4, "Vous n'avez pas assez de blé");
            
            index = AddCraft(typeof(PicnicBasket), "Contenants", "Panier à pique-nique", 45.0, 60.0, typeof(WheatSheaf), "Gerbe de blé", 2, "Vous n'avez pas assez de blé");
            AddRes(index, typeof(Leather), 1044462, 1, 1044463);

            index = AddCraft(typeof(GiftBox), "Contenants", "Boite à cadeaux", 75.0, 90.0, typeof(Cloth), 1044286, 4, 1044287);
            #endregion
            ...
            AddSubRes(typeof(DaemonLeather), "DAEMON", 105.0, 1044462);
			MarkOption = true;
			Repair = Core.AOS;
			CanEnhance = Core.AOS;
