...
namespace Server.Engines.Craft
{
	public class CraftGumpItem : Gump
	{
        ...
        private double m_Chance = 0;   // Scriptiz : on stocke la chance pour afficher les quantités si > 1
		...
		public void DrawResource()
		{
			...
			for ( int i = 0; i < m_CraftItem.Resources.Count - (cropScroll ? 1 : 0) && i < 4; i++ )
			{
                ...
                // Scriptiz : si GM ou 100% réussite, on affiche la quantité requise
                if (m_From.AccessLevel >= AccessLevel.GameMaster || m_Chance >= 1)
