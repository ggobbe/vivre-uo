//Myron - Comment des ressources pour coller à celles disponibles dans les autres menus
using System; 
using Server.Items; 
...
{ 
	...
	{ 
		...
		{ 
            ...
            index = AddCraft(typeof(SlayerForge), "Misc", "Bassine à Slayers", 70.0, 100.0, typeof(GoldGranite), "Granite d'or", 2, 1044513);
            AddRes(index, typeof(Pitcher), "Pichet d'eau", 3);
            AddRes(index, typeof(MagicReflectScroll), "Parchemin de réflection", 2);
