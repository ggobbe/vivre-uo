...
namespace Server.Engines.Craft
{
	public class DefCooking : CraftSystem
	{
		...
		public override void InitCraftList()
		{
            ...
            index = AddCraft(typeof(TitanOre), "Misc", "Gravat de titan", 60.0, 85.0, typeof(TitanToothPowder), "Poudre de dent de titan", 1, "Vous n'avez pas assez de poudre de dent de titan");
            SetNeedOven(index, true);
            SetUseAllRes(index, true);

            index = AddCraft(typeof(FruitBasket), "Misc", "Panier de fruits", 30.0, 50.0, typeof(Basket), "Panier vide", 1, "Vous n'avez pas de panier convenable");
            AddRes(index, typeof(Pear), "Poire", 1, "Vous n'avez rien pour bien agrémenter le tout");
            AddRes(index, typeof(Grapes), "Raisin", 1, "Vous n'avez rien pour bien agrémenter le tout");
            AddRes(index, typeof(Peach), "Pêche", 1, "Vous n'avez rien pour bien agrémenter le tout");
            AddRes(index, typeof(Apple), "Pomme", 1, "Vous n'avez rien pour bien agrémenter le tout");
            AddRes(index, typeof(CreateFoodScroll), "Parchemin de création de nourriture", 1, "Un parchemin de création de nourriture ajouterait de la fantaisie");

            index = AddCraft(typeof(CacaoPowder), "Misc", "Poudre de cacao", 60.0, 85.0, typeof(CacaoSeed), "Fève de Cacao", 1, "Vous avez besoin de davantage de fèves");
            SetNeedOven(index, true);
            SetUseAllRes(index, true);

            index = AddCraft(typeof(RedLollipop), "Friandises", "Sucette à la pomme", 40.0, 80.0, typeof(Kindling), 1015157, 1, "Vous n'avez rien pour faire le baton");
            AddRes(index, typeof(JarHoney), 1044472, 1, "Vous n'avez rien pour créer la consistance");
            AddRes(index, typeof(Apple), "Apple", 1, "Vous n'avez rien pour créer la saveur");
            SetNeedHeat(index, true);

            index = AddCraft(typeof(GreenLollipop), "Friandises", "Sucette au melon d'eau", 40.0, 80.0, typeof(Kindling), 1015157, 1, "Vous n'avez rien pour faire le baton");
            AddRes(index, typeof(JarHoney), 1044472, 1, "Vous n'avez rien pour créer la consistance");
            AddRes(index, typeof(Watermelon), "Watermelon", 1, "Vous n'avez rien pour créer la saveur");
            SetNeedHeat(index, true);

            index = AddCraft(typeof(YellowLollipop), "Friandises", "Sucette au citron", 40.0, 80.0, typeof(Kindling), 1015157, 1, "Vous n'avez rien pour faire le baton");
            AddRes(index, typeof(JarHoney), 1044472, 1, "Vous n'avez rien pour créer la consistance");
            AddRes(index, typeof(Lemon), "Lemon", 1, "Vous n'avez rien pour créer la saveur");
            SetNeedHeat(index, true);

            index = AddCraft(typeof(RedCandyCane), "Friandises", "Canne aux fruits", 45.0, 70.0, typeof(Sugar), "Sucre", 2, "Vous n'avez pas assez de sucre");
            AddRes(index, typeof(Pear), "Poire", 1, "Vous n'avez rien pour créer la saveur");
            AddRes(index, typeof(Peach), "Pêche", 1, "Vous n'avez rien pour créer la saveur");


            index = AddCraft(typeof(GreenCandyCane), "Friandises", "Canne à la limette", 45.0, 70.0, typeof(Sugar), "Sucre", 2, "Vous n'avez pas assez de sucre");
            AddRes(index, typeof(Lime), "Lime", 1, "Vous n'avez rien pour créer la saveur");

            index = AddCraft(typeof(GingerBreadCookie), "Friandises", "Pain d'épices", 50.0, 75.0, typeof(GingerRoot), "Gingembre", 2, "Vous n'avez pas assez de gingembre");
            AddRes(index, typeof(Sugar), "Sucre", 1, "Vous n'avez rien pour le personnaliser");
            SetNeedOven(index, true);

            index = AddCraft(typeof(Jellybeans), "Friandises", "Dragées surprises", 60.0, 85.0, typeof(Sugar), "Sucre", 5, "Vous n'avez pas assez de sucre");
            AddRes(index, typeof(FruitBasket), "Panier de fruits", 1, "Vous aurez besoin de davantage de saveurs");

            index = AddCraft(typeof(Nougat), "Friandises", "Nougat", 70.0, 95.0, typeof(CacaoPowder), "Poudre de cacao", 2, "Vous n'avez pas assez de cacao");
            AddRes(index, typeof(Sugar), "Sucre", 1, "Vous n'avez pas assez de sucre");

            index = AddCraft(typeof(GingerBreadHouseDeed), "Friandises", "Maison en pain d'épices (décoration)", 80.0, 110.0, typeof(GingerRoot), "Gingembre", 10, "Vous n'avez pas assez de gingembre");
            AddRes(index, typeof(Sugar), "Sucre", 5, "Vous n'avez pas assez de sucre pour la décoration");
            AddRes(index, typeof(CacaoPowder), "Poudre de Cacao", 10, "Vous n'avez pas assez de cacao pour le terrain");
            AddRes(index, typeof(Jellybeans), "Dragées surprises", 4, "Vous n'avez pas assez de dragées pour l'arbre");
            AddRes(index, typeof(RedCandyCane), "Canne aux fruits", 2, "Vous n'avez pas assez de cannes pour les poteaux");
            AddRes(index, typeof(GingerBreadCookie), "Bonhomme en pain d'épices", 2, "Il faut des gens pour habiter dans cette maison!");
            SetNeedOven(index, true);
