	...
	public class DefTinkering : CraftSystem
	{
		...
		private static Type[] m_TinkerColorables = new Type[]
			{
				...
				typeof( HeatingStand ), typeof(CandelabraStand)
			};
        ...
        */
        public override void InitCraftList()
		{
			...
			//Myron - Ajout des outils glassbow et masonry
			AddCraft( typeof( ScribesPen ), 1044046, 1044168, 25.0, 75.0, typeof( IronIngot ), 1044036, 1, 1044037 );
			AddCraft( typeof( Blowpipe ), 1044046, 1044608, 60.0, 100.0, typeof( IronIngot ), 1044036, 5, 1044037 );
			AddCraft( typeof( MalletAndChisel ), 1044046, 1024787, 60.0, 100.0, typeof( IronIngot ), 1044036, 5, 1044037 );
			AddCraft( typeof( Nails ), 1044046, 1024142, 30.0, 80.0, typeof( IronIngot ), 1044036, 2, 1044037 );
			#endregion
			...
			#region Containers
            //Myron - Ajouts des coffres métalliques
			AddCraft( typeof( MetalBox ),1044292, 1022472,	21.0,  46.0,	typeof( IronIngot ), 1044036, 5, 1044037 );
			AddCraft( typeof( MetalChest ),1044292, 1022475,	73.6,  98.6,	typeof( IronIngot ),  1044036, 10, 1044037 );
			index = AddCraft( typeof( MetalGoldenChest ),1044292, "Coffre de fer avec dorures",	73.6,  98.6,	typeof( IronIngot ),  1044036, 10, 1044037 );
			AddRes( index, typeof( GoldIngot ), "Or", 1, 1044037 );
            AddCraft(typeof(DonationBox), 1044292, "Boite à dons", 25.0, 55.0, typeof(IronIngot), 1044036, 5, 1044037);


            // Scriptiz : ajout du semoir pour y ranger ses graines
            index = AddCraft(typeof(SeedBox), 1044292, "Semoir", 81.5, 106.5, typeof(Log), 1044041, 5, 1044351);
            AddRes(index, typeof(WheatSheaf), 1044489, 3);
			#endregion
            ...
            AddCraft(typeof(Fork), 1044048, "Une fourchette", 0.0, 50.0, typeof(IronIngot), 1044036, 1, 1044037);
            ...
            AddRes(index, typeof(Candle), "Chandelles", 3, "Vous n'avez pas les chandelles requises");
            index = AddCraft(typeof(CandelabraStand), 1044050, 1022599, 65.0, 105.0, typeof(IronIngot), 1044036, 6, 1044037);
            AddRes(index, typeof(Candle), "Chandelles", 3, "Vous n'avez pas les chandelles requises");
            ...
            AddCraft(typeof(ResourceBucket), 1044050, "Seau de récolte", 50.0, 100.0, typeof(DullcopperIngot), "Lingots de Cuivre Terni", 4, "Vous n'avez pas assez de Cuivre Terni pour faire cela");

            index = AddCraft(typeof(Candle), 1044050, "Chandelle", 23.0, 38.2, typeof(BronzeIngot), "Lingot de bronze", 1, "Vous n'avez pas assez de bronze");
            AddRes(index, typeof(Beeswax), "Cire d'abeille", 2, "Vous n'avez pas assez de cire");
            AddRes(index, typeof(Bandage), "Bout de tissus", 1, "Il vous faut un petit morceau de tissus");
            SetNeedHeat(index, true);

            AddCraft(typeof(RustyNails), 1044050, "Clous rouillés", 60.0, 90.0, typeof(RustyIngot), "De la rouille", 2, 1044037);
            ...
            index = AddCraft(typeof(PoteauArnachement), 1044050, "Poteau d'Arnachement", 65.0, 115.0, typeof(Log), 1044041, 2, 1044351);
            AddRes(index, typeof(BronzeIngot), "Lingot de bronze", 6, "Vous n'avez pas assez de bronze pour faire cela");
            AddSkill(index, SkillName.Blacksmith, 45.0, 60.0);
            AddSkill(index, SkillName.AnimalLore, 10.0, 30.0);

			#endregion

			#region Jewelry
            AddCraft(typeof(GoldRing), 1044049, "Bague", 40.0, 90.0, typeof(IronIngot), 1044036, 2, 1044037);
            index = AddCraft(typeof(GoldBeadNecklace), 1044049, "Collier de perles", 30.0, 80.0, typeof(IronIngot), 1044036, 2, 1044037);
            AddRes(index, typeof(BlackPearl), "Perles noires", 10, "Vous n'avez pas assez de perles pour faire cela");
            AddCraft(typeof(GoldNecklace), 1044049, "Collier", 50.0, 100.0, typeof(IronIngot), 1044036, 2, 1044037);
            AddCraft(typeof(GoldEarrings), 1044049, "Boucles d'oreille", 40.0, 90.0, typeof(IronIngot), 1044036, 2, 1044037);
            AddCraft(typeof(GoldBracelet), 1044049, "Bracelet", 40.0, 90.0, typeof(IronIngot), 1044036, 2, 1044037);
            AddCraft(typeof(Diademe), 1044049, "Diadème", 60.0, 110.0, typeof(IronIngot), 1044036, 2, 1044037);
            index = AddCraft(typeof(DiademeDecore), 1044049, "Diadème (riche)", 70.0, 120.0, typeof(IronIngot), 1044036, 3, 1044037);
            // Scriptiz : quelques pierres précieuses en plus pour le diademe décoré
            ...
            index = AddCraft(typeof(FermentationBarrel), 1044051, "Tonneau de Distillerie", 15.0, 60.0, typeof(Log), 1044041, 1, 1044351);
            AddRes(index, typeof(BarrelHoops), 1044289, 1, 1044253);

            index = AddCraft(typeof(CheeseForm), 1044051, "Moule à Fromage", 15.0, 60.0, typeof(BasketFrame), "Corps de panier", 1, "Vous n'avez rien pour créer la structure");
            AddRes(index, typeof(BlankScroll), 1044377, 10, 1044378);

            index = AddCraft(typeof(IronBeetleBody), 1044051, "Corps de scarabé de fer", 60, 115.0, typeof(IronOre), 1044036, 1500, 1044037);
            AddRes(index, typeof(AgapiteOre), "Agapite", 50, "Vous n'avez pas assez d'agapite");
            AddRes(index, typeof(AxleGears), 1044170, 30, 1044253);
            AddSkill(index, SkillName.Mysticism, -10.0, 50.0);
			#endregion
            ...
            #region Scriptiz : ajout des panneaux craftables
            index = AddCraft(typeof(TailorSign), "Pancartes", "Pancarte de barbier", 60, 80, typeof(IronIngot), 1044036, 2, 1044037);
            AddRes(index, typeof(Nails), "Clous", 4, "Vous n'avez pas assez de clous");

            index = AddCraft(typeof(TinkerSign), "Pancartes", "Pancarte de bricoleur", 60, 80, typeof(IronIngot), 1044036, 2, 1044037);
            AddRes(index, typeof(Nails), "Clous", 4, "Vous n'avez pas assez de clous");

            index = AddCraft(typeof(WoodworkerSign), "Pancartes", "Pancarte de bucheron", 60, 80, typeof(IronIngot), 1044036, 2, 1044037);
            AddRes(index, typeof(Nails), "Clous", 4, "Vous n'avez pas assez de clous");

            index = AddCraft(typeof(BlacksmithSign), "Pancartes", "Pancarte de forgeron", 60, 80, typeof(IronIngot), 1044036, 2, 1044037);
            AddRes(index, typeof(Nails), "Clous", 4, "Vous n'avez pas assez de clous");

            index = AddCraft(typeof(WoodenSign), "Pancartes", "Pancarte inscriptible en bois", 80, 100, typeof(Log), 1044041, 2, 1044351);
            AddRes(index, typeof(Nails), "Clous", 4, "Vous n'avez pas assez de clous");
            AddRes(index, typeof(ScribesPen), "Plume de scribe", 1, "Vous n'avez pas de plume de scribe");

            index = AddCraft(typeof(GoldSign), "Pancartes", "Pancarte inscriptible en or", 80, 100, typeof(GoldIngot), "Lingot d'or", 2, "Vous n'avez pas assez de lingots d'or");
            AddRes(index, typeof(Nails), "Clous", 4, "Vous n'avez pas assez de clous");
            AddRes(index, typeof(ScribesPen), "Plume de scribe", 1, "Vous n'avez pas de plume de scribe");
            #endregion
            ...
            AddSubRes(typeof(IronIngot), "Fer", 00.0, 10442687);
            AddSubRes(typeof(RustyIngot), "Rusty", 30.0, 1044268);
            AddSubRes(typeof(OldcopperIngot), "Vieux Cuivre", 30.0, 1044268);
            AddSubRes(typeof(DullcopperIngot), "Cuivre terni", 55.0, 1044268);
            AddSubRes(typeof(ShadowIngot), "Sombrine", 60.0, 1044268);
            AddSubRes(typeof(CopperIngot), "Cuivre", 60.0, 1044268);
            AddSubRes(typeof(BronzeIngot), "Bronze", 65.0, 1044268);
            AddSubRes(typeof(GoldIngot), "Or", 70.0, 1044268);
            AddSubRes(typeof(RoseIngot), "Rose", 99.0, 1044268);
            AddSubRes(typeof(AgapiteIngot), "Agapite", 85.0, 1044268);
            AddSubRes(typeof(ValoriteIngot), "Valorite", 90.0, 1044268);
            //AddSubRes(typeof(BloodrockIngot), "Roche de sang", 75.0, 1044268);
            AddSubRes(typeof(VeriteIngot), "Verite", 80.0, 1044268);
            AddSubRes(typeof(SilverIngot), "Argent", 85.0, 1044268);
            AddSubRes(typeof(DragonIngot), "Dragon", 90.0, 1044268);
            AddSubRes(typeof(TitanIngot), "Titan", 95.0, 1044268);
            //AddSubRes(typeof(CrystalineIngot), "Crystaline", 99.0, 1044268);
            //AddSubRes(typeof(KryniteIngot), "Krynite", 65.0, 1044268);
            //AddSubRes(typeof(BloodcrestIngot), "Craie de sang", 75.0, 1044268);
            //AddSubRes(typeof(ElvinIngot), "Elvin", 80.0, 1044268);
            //AddSubRes(typeof(AcidIngot), "Acid", 85.0, 1044268);
            //AddSubRes(typeof(AquaIngot), "Aqua", 90.0, 1044268);
            AddSubRes(typeof(EldarIngot), "Eldar", 95.0, 1044268);
            AddSubRes(typeof(GlowingIngot), "Glowing", 99.0, 1044268);
            AddSubRes(typeof(VulcanIngot), "Vulcan", 99.0, 1044268);

            //AddSubRes(typeof(GorganIngot), "Gorgan", 65.0, 1044268);
            //AddSubRes(typeof(SteelIngot), "Acier", 70.0, 1044268);
            //AddSubRes(typeof(SandrockIngot), "Pierre de sable", 75.0, 1044268);
            //AddSubRes(typeof(MytherilIngot), "Mytheril", 80.0, 1044268);
            AddSubRes(typeof(BlackrockIngot), "Pierre noire", 99.0, 1044268);
