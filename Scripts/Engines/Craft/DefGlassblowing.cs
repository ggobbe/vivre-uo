...
namespace Server.Engines.Craft
{
	public class DefGlassblowing : CraftSystem
	{
		...
		public override void InitCraftList()
		{
            ...
            // Scriptiz : Ajout des verres craftables
            AddCraft(typeof(Glass), 1044050, 1116636, 42.5, 92.5, typeof(Sand), 1044625, 1, 1044627);
            ...
            // Plume : Ajout de la fiole d'alchimie
            AddCraft(typeof(AlchemyVial), 1044050, "Fiole d'alchimie", 70.0, 115.0, typeof(Sand), 1044625, 2, 1044627);

            index = AddCraft(typeof(MysticPowerCrystal), 1044050, 1072895, 40.0, 130.0, typeof(Sand), 1044625, 20, 1044627);
            AddSkill(index, SkillName.SpiritSpeak, 20.0, 110.0);
            AddRes(index, typeof(BaseGem), "Gemmes (variées)", 100, "Vous n'avez pas assez de gemmes");            
		}
	}
}