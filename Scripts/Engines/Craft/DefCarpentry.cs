...
namespace Server.Engines.Craft
{
	public class DefCarpentry : CraftSystem
	{
		...
		public override void InitCraftList()
		{
            ...
            // Scriptiz : ajout de parchemins vierges
            AddCraft(typeof(BlankScroll), 1044294, "10 Parchemin vierge", 50.0, 50.1, typeof(Log), 1044041, 10, 1044351);
            ...
            index = AddCraft(typeof(BasketFrame), 1044294, "Corps de panier", 25.0, 50.0, typeof(Log), 1044041, 3, 1044351);
            AddRes(index, typeof(Nails), "Clous", 5, "Vous n'avez pas assez de clous");
            ...
            // Scriptiz : chaises elfiques (basées sur les thrones)
            if (Core.ML)
            {
            ...
            AddCraft(typeof(BigElvenChair), 1044291, 1072872, 75.6, 100.6, typeof(Log), 1044041, 24, 1044351);
            AddCraft(typeof(ElvenReadingChair), 1044291, 1072873, 77.6, 102.6, typeof(Log), 1044041, 26, 1044351);


            //Vinds : tables avec traverse, modulables

            index = AddCraft(typeof( TableRunnerPurple ), 1044291, "Table Avec Traverse (violette)", 63.1, 88.1, typeof(Log), 1044041, 23, 1044351);
            AddSkill(index, SkillName.Tailoring, 95.1, 115.1);
            AddRes(index, typeof(Cloth), 1044286, 10, 1044287);

            index = AddCraft(typeof( TableRunnerBlue ), 1044291,"Table Avec Traverse (Bleue)", 63.1, 88.1, typeof(Log), 1044041, 23, 1044351);
            AddSkill(index, SkillName.Tailoring, 95.1, 115.1);
            AddRes(index, typeof(Cloth), 1044286, 10, 1044287);

            index = AddCraft(typeof( TableRunnerRed ), 1044291, "Table Avec Traverse (Rouge)", 63.1, 88.1, typeof(Log), 1044041, 23, 1044351);
            AddSkill(index, SkillName.Tailoring, 95.1, 115.1);
            AddRes(index, typeof(Cloth), 1044286, 10, 1044287);

            index = AddCraft(typeof( TableRunnerOrange ), 1044291, "Table Avec Traverse (Orange)", 63.1, 88.1, typeof(Log), 1044041, 23, 1044351);
            AddSkill(index, SkillName.Tailoring, 95.1, 115.1);
            AddRes(index, typeof(Cloth), 1044286, 10, 1044287);

            index = AddCraft(typeof(TabletteRunner), 1044291, "Petite table avec Traverse (pivotable)", 63.1, 88.1, typeof(Log), 1044041, 18, 1044351);
            AddSkill(index, SkillName.Tailoring, 92.1, 112.1);
            AddRes(index, typeof(Cloth), 1044286, 10, 1044287);

            index = AddCraft(typeof(ExtTabletteRunner), 1044291, "Rallonge avec traverse", 63.1, 88.1, typeof(Log), 1044041, 18, 1044351);
            AddSkill(index, SkillName.Tailoring, 95.1, 115.1);
            AddRes(index, typeof(Cloth), 1044286, 10, 1044287);

            index = AddCraft(typeof(TableLongRunnerW), 1044291, "Table longue avec traverse (W)", 63.1, 88.1, typeof(Log), 1044041, 23, 1044351);
            AddSkill(index, SkillName.Tailoring, 92.1, 112.1);
            AddRes(index, typeof(Cloth), 1044286, 10, 1044287);

            index = AddCraft(typeof(TableLongRunnerC), 1044291, "Table longue avec traverse (c)", 63.1, 88.1, typeof(Log), 1044041, 23, 1044351);
            AddSkill(index, SkillName.Tailoring, 95.1, 115.1);
            AddRes(index, typeof(Cloth), 1044286, 10, 1044287);


            index = AddCraft(typeof(TableLongRunnerE), 1044291, "Table longue avec traverse (E) ", 63.1, 88.1, typeof(Log), 1044041, 23, 1044351);
            AddSkill(index, SkillName.Tailoring, 95.1, 115.1);
            AddRes(index, typeof(Cloth), 1044286, 10, 1044287);
			...
			AddCraft( typeof( EmptyBookcase ),				1044292, "Etagère vide",	31.5,  56.5,	typeof( Log ), 1044041, 25, 1044351 );
            
            // Scriptiz : ajout de l'étagère remplie de livres
            index = AddCraft(typeof(FullBookcase), 1044292, "Etagère remplie", 84.2, 109.2, typeof(Log), 1044041, 25, 1044351);
            AddRes(index, typeof(BlueBook), "Livres bleus", 3);
            AddRes(index, typeof(RedBook), "Livres rouges", 3);
            AddRes(index, typeof(TanBook), "Livres beiges", 3);
            AddRes(index, typeof(BrownBook), "Livres bruns", 3);
			...
			// Staves and Shields
			AddCraft( typeof( ShepherdsCrook ), "Armes et Boucliers", 1023713, 78.9, 103.9, typeof( Log ), 1044041, 7, 1044351 );
            ...
            AddCraft(typeof(WoodenShield), "Armes et Boucliers", 1027034, 52.6, 77.6, typeof(Log), 1044041, 9, 1044351);

			if( !Core.AOS )	//Duplicate Entries to preserve ordering depending on era 
			{
                index = AddCraft(typeof(FishingPole), "Armes et Boucliers", 1023519, 68.4, 93.4, typeof(Log), 1044041, 5, 1044351); //This is in the categor of Other during AoS
				AddSkill( index, SkillName.Tailoring, 40.0, 45.0 );
				AddRes( index, typeof( Cloth ), 1044286, 5, 1044287 );
			}

            AddCraft(typeof(TrainingBow), "Armes et Boucliers", "Arc d'entrainement", 20.0, 40.0, typeof(Log), 1044041, 1, 1044351);
            AddCraft(typeof(TrainingDagger), "Armes et Boucliers", "Dague d'entrainement", 20.0, 40.0, typeof(Log), 1044041, 1, 1044351);
            AddCraft(typeof(TrainingSword), "Armes et Boucliers", "Épée d'entrainement", 20.0, 40.0, typeof(Log), 1044041, 1, 1044351);
            AddCraft(typeof(TrainingClub), "Armes et Boucliers", "Masse d'entrainement", 20.0, 40.0, typeof(Log), 1044041, 1, 1044351);

			if( Core.SE )
			{
                index = AddCraft(typeof(Bokuto), "Armes et Boucliers", 1030227, 70.0, 95.0, typeof(Log), 1044041, 6, 1044351);
				SetNeededExpansion( index, Expansion.SE );

                index = AddCraft(typeof(Fukiya), "Armes et Boucliers", 1030229, 60.0, 85.0, typeof(Log), 1044041, 6, 1044351);
				SetNeededExpansion( index, Expansion.SE );

                index = AddCraft(typeof(Tetsubo), "Armes et Boucliers", 1030225, 80.0, 140.3, typeof(Log), 1044041, 10, 1044351); 
                SetNeededExpansion(index, Expansion.SE);
			}
            index = AddCraft(typeof(BlankWand), "Armes et Boucliers", "Baguette de bois", 60.0, 80.0, typeof(GoldIngot), "Lingot d'or", 1, "Vous n'avez pas de lingot d'or");
			...
			index = AddCraft( typeof( PentagramDeed ), 1044290, 1044328, 95.0, 125.0, typeof( Log ), 1044041, 100, 1044351 );
			AddSkill( index, SkillName.Magery, 75.0, 80.0 );
			AddRes( index, typeof( IronIngot ), 1044036, 40, 1044037 );
			index = AddCraft( typeof( AbbatoirDeed ), 1044290, 1044329, 95.0, 125.0, typeof( Log ), 1044041, 100, 1044351 );
