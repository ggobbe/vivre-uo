...
namespace Server.Spells.Chivalry
{
	public class HolyLightSpell : PaladinSpell
	{
        ...
        public override string ArtedarMantra { get { return "Ipsos Hemen"; } }
		...
		public override void OnCast()
		{
			if ( CheckSequence() )
			{
                ...
                if (Caster is PlayerMobile && ((PlayerMobile)Caster).IsArtedarKnight)// Vinds : switch cosmétique
                {
                    Effects.SendLocationParticles(EffectItem.Create(Caster.Location, Caster.Map, EffectItem.DefaultDuration), 0x376A, 1, 29, 0x20, 2, 9962, 0);
                    Effects.SendLocationParticles(EffectItem.Create(new Point3D(Caster.X, Caster.Y, Caster.Z - 7), Caster.Map, EffectItem.DefaultDuration), 0x37C4, 1, 29, 0x1B, 2, 9502, 0);           
                }
