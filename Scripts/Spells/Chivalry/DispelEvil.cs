...
namespace Server.Spells.Chivalry
{
	public class DispelEvilSpell : PaladinSpell
	{
        ...
        public override string ArtedarMantra { get { return "Dys Iden Xiah"; } }
		...
		{
            Caster.FixedEffect(0x37C4, 10, 7, (Caster is PlayerMobile && ((PlayerMobile)Caster).IsArtedarKnight) ? 37 : 4, 3); // At player
		}
