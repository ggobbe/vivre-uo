...
namespace Server.Spells.Chivalry
{
	public class CloseWoundsSpell : PaladinSpell
	{
        ...
        public override string ArtedarMantra { get { return "Ichor Natalis"; } }
		...
		public void Target( Mobile m )
		{
			...
			else if ( CheckBSequence( m ) )
			{
                ...
                if (m is PlayerMobile && ((PlayerMobile)m).IsArtedarKnight) //Vinds : switch cosmétique suivant le dieu
                {

                    m.PlaySound(0x202);
                    m.FixedParticles(0x376A, 1, 62, 9923, 32, 3, EffectLayer.Waist);
                    m.FixedParticles(0x3779, 1, 46, 9502, 27, 3, EffectLayer.Waist); 
                }
