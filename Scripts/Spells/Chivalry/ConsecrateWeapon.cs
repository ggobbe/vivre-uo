...
namespace Server.Spells.Chivalry
{
	public class ConsecrateWeaponSpell : PaladinSpell
	{
        ...
        public override string ArtedarMantra { get { return "Languor Vindicare"; } }
		...
		public override void OnCast()
		{
			...
			else if ( CheckSequence() )
			{
				...
				Caster.FixedParticles( 0x3779, 1, 30, 9964,(Caster is PlayerMobile && ((PlayerMobile)Caster).IsArtedarKnight) ? 37 : 3, 3, EffectLayer.Waist );
