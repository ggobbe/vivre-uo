...
namespace Server.Spells.Chivalry
{
	public class RemoveCurseSpell : PaladinSpell
	{
        ...
        public override string ArtedarMantra { get { return "Sanctum Damnare"; } }
		...
		public void Target( Mobile m )
		{
			if ( CheckBSequence( m ) )
			{
				...
				if ( Caster.Fame < 1000 )
					chance = 0;
				else if ( Caster.Fame < 2000 )
					chance = (int) Math.Sqrt( 20000 + ( 1.75*  Caster.Fame) ) - 122;
				else if ( Caster.Fame < 5000 )
					chance = (int) Math.Sqrt( Caster.Fame ) + 25;
				else
					chance = 100;
                }
