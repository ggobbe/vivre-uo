...
namespace Server.Spells.Chivalry
{
	public class DivineFurySpell : PaladinSpell
	{
        ...
        public override string ArtedarMantra { get { return "Ventus Irae"; } }
		...
		public override void OnCast()
		{
			if ( CheckSequence() )
			{
				...
				Caster.FixedParticles( 0x376A, 1, 31, 9961, (Caster is PlayerMobile && ((PlayerMobile)Caster).IsArtedarKnight) ? 37 :1160, 0, EffectLayer.Waist ); // Vinds : encore du cosmétique
				Caster.FixedParticles( 0x37C4, 1, 31, 9502,(Caster is PlayerMobile && ((PlayerMobile)Caster).IsArtedarKnight) ? 27 : 43, 2, EffectLayer.Waist );
