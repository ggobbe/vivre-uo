	...
	public class CurseWeaponSpell : NecromancerSpell
	{
		...
		public override void OnCast()
		{
			...
			else if ( CheckSequence() )
			{
                ...
                // Scriptiz : le karma négatif augmente la durée du sort
                TimeSpan duration = TimeSpan.FromSeconds((Caster.Skills[SkillName.SpiritSpeak].Value / 3.4) + 1.0 - (Caster.Karma / 1000.0));
