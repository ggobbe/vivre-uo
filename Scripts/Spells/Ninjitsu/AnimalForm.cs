...
namespace Server.Spells.Ninjitsu
{
	public class AnimalForm : NinjaSpell
	{
		...
		*/
		...
		public class AnimalFormEntry
		{
            ...
            private string m_NameMod; // Vinds : ajout d'une entrée pour l'anonymisation
            ...
            public string NameMod { get { return m_NameMod; } }
			...
			*/
            ...
            public AnimalFormEntry(Type type, TextDefinition name, int itemID, int hue, int tooltip, double reqSkill, int bodyMod, int hueModMin, int hueModMax, bool stealthBonus, bool speedBoost, bool stealingBonus, string NameMod)
            {
                m_Type = type;
                m_Name = name;
                m_ItemID = itemID;
        ...
        private static AnimalFormEntry[] m_Entries = new AnimalFormEntry[]
			{
                new AnimalFormEntry( typeof( Panther ),      1015239,  9653,    0, 1070811, 90.0,  0xD6, 0x8FD, 0x90E, false,  true, false, "Panthere" ),
				//new AnimalFormEntry( typeof( Kirin ),        1029632,  9632,    0, 1070811, 90.0,  0x84,     0,     0, false,  true, false, "Kirin" ), 
				new AnimalFormEntry( typeof( Unicorn ),      1018214,  9678,    0, 1070812, 90.0,  0x7A,     0,     0, false,  true, false, "Licorne" ),
				new AnimalFormEntry( typeof( BakeKitsune ),  1030083, 10083,    0, 1070810,  82.5,  0xF6,     0,     0, false,  true, false, "BakeKitsune" ), 
				new AnimalFormEntry( typeof( GreyWolf ),     1028482,  9681, 2309, 1070810,  82.5,  0x19, 0x8FD, 0x90E, false,  true, false, "Loup" ),
				new AnimalFormEntry( typeof( Bird ),         1072464,  8477,    0, 1070809,  70.0,  0x5,  0x8B0, 0x8B0, false,  true, false, "Corbeau" ),
				new AnimalFormEntry( typeof( ForestOstard ), 1018273,  8503, 2212, 1070809,  70.0,  0xDB, 0x899, 0x8B0, false,  true, false, "Ostard" ),
				//new AnimalFormEntry( typeof( Llama ),        1028438,  8438,    0, 1070809,  70.0,  0xDC,     0,     0, false,  true, false, "Lama" ),
			    new AnimalFormEntry( typeof( BullFrog ),     1028496,  8496, 2003, 1070807,  50.0,  0x51, 0x7D1, 0x7D6, false, false, false, "Crapaud" ),
				new AnimalFormEntry( typeof( GiantSerpent ), 1018114,  9663, 2009, 1070808,  50.0,  0x15, 0x7D1, 0x7E2, false, false, false, "Serpent Geant" ),
				new AnimalFormEntry( typeof( Dog ),          1018280,  8476, 2309, 1070806,  40.0,  0xD9, 0x8FD, 0x90E, false, false, false, "Chien" ),
				new AnimalFormEntry( typeof( Cat ),          1018264,  8475, 2309, 1070806,  40.0,  0xC9, 0x8FD, 0x90E, false, false, false, "Chat" ),
				new AnimalFormEntry( typeof( Rat ),          1018294,  8483, 2309, 1070805,  20.0,  0xEE, 0x8FD, 0x90E,  true, false, false, "Rat" ),
				new AnimalFormEntry( typeof( Rabbit ),       1028485,  8485, 2309, 1070805,  20.0,  0xCD, 0x8FD, 0x90E,  true, false, false, "Lapin" ),
				new AnimalFormEntry( typeof( Squirrel ),     1031671, 11671,    0,       0,  20.0, 0x116,     0,     0, false, false, false, "Renard" ),
				new AnimalFormEntry( typeof( Ferret ),       1031672, 11672,    0, 1075220,  40.0, 0x117,     0,     0, false, false,  true, "Furet" ),
				new AnimalFormEntry( typeof( CuSidhe ),      1031670, 11670,    0, 1075221,  60.0, 0x115,     0,     0, false, false, false, "Cu Sidhe" ),
				new AnimalFormEntry( typeof( Reptalon ),     1075202, 11669,    0, 1075222,  90.0, 0x114,     0,     0, false, false, false, "Reptalon" ),
			};
	...
	public class AnimalFormTimer : Timer
	{
        ...
        private int m_Duration; // Scriptiz : fin de l'effet
        private int m_Ticks;    // Scriptiz : pour limiter l'effet
			...
			: base(TimeSpan.FromSeconds(1.0), TimeSpan.FromSeconds(1.0))
		{
            ...
            // Scriptiz : Le sort a un effet limité en fonction de ninjitsu et de la dex
            m_Duration = 3 + (int)Math.Floor(from.Skills[SkillName.Ninjitsu].Value * (from.Dex / 40.0));
            m_Ticks = 0;    // pour garder le nombre de ticks (1 par seconde)
		}
