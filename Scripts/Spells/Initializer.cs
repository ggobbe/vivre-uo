    ...
    public class Initializer
    {
        public static void Initialize()
        {
            ...
            if (Core.AOS)
            {
                ...
                // Scriptiz : sorts de nécro de vivre (TODO : ajouter dans le spellbook.GetTypeForSpell (ligne 130)
                Register(700, typeof(VivreNecromancy.SummonUndead));
                Register(701, typeof(VivreNecromancy.AnimateCorpse));
                Register(702, typeof(VivreNecromancy.BoneArmor));
                Register(703, typeof(VivreNecromancy.AbyssLight));
                Register(704, typeof(VivreNecromancy.AbyssFire));
                Register(705, typeof(VivreNecromancy.MinorLifeLeech));
            }
        }
