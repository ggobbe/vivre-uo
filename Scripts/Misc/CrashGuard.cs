...
namespace Server.Misc
{
	public class CrashGuard
	{
		...
		private static bool RestartServer = false;  // Scriptiz en attendant pour éviter le restart too many !
		...
		private static void SendEmail( string filePath )
		{
            ...
            MailMessage message = new MailMessage(Email.FromAddress, Email.CrashAddresses); // Scriptiz : email valide !
