		...
		private static string[] m_Messages = ( TestCenter.Enabled ?
			...
			new string[]
				{	//Yes, this message is a pathetic message, It's suggested that you change it.
					"Bienvenue sur Vivre : La Renaissance.",
					"Toute l'équipe vous souhaite une expérience agréable.",
                    "N'hésitez pas à utiliser le chat (.c) ou le forum pour toutes questions.",
				} );
