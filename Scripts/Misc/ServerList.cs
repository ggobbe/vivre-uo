...
namespace Server.Misc
{
	public class ServerList
	{
        ...
        public static readonly string Address = "runuo.vivre-uo.fr";
		public static readonly string ServerName = "Vivre";
		...
		private static bool IsPrivateNetwork( IPAddress ip )
		{
            ...
            // Scriptiz : Fix for Windows Azure VM's Internal IP Address
            if (Utility.IPMatch("100.90.*", ip))
                return true;
