		...
		public class PoisonTimer : Timer
		{
			...
			protected override void OnTick()
			{
					...
					AnimalForm.UnderTransformation( m_Mobile, typeof( Unicorn ) ) )
				{
					...
					{
						m_Mobile.LocalOverheadMessage( MessageType.Emote, 0x3F, false,
							"* Vous résistez les effets du poison *" );

						m_Mobile.NonlocalOverheadMessage( MessageType.Emote, 0x3F, true,
							String.Format( "* {0} résiste au poison *", m_Mobile.Name ) );
				...
				{
					m_Mobile.SendMessage( "Les effets du poison s'atténuent" ); // The poison seems to have worn off.
