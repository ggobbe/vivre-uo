...
namespace Server
{
    public class LootPack
    {
        ...
        public static readonly LootPack MlRich = new LootPack(new LootPackEntry[]
			{
				new LootPackEntry(  true, Gold,						70.00, "2d50+225" ),
				new LootPackEntry( true, AosMagicItemsRichType1,	50.00, 1, 3, 0, 75 ),
				new LootPackEntry( false, AosMagicItemsRichType1,	 30.00, 1, 5, 0, 100 ),
        ...
        public static readonly LootPack SePoor = new LootPack(new LootPackEntry[]
			{
				new LootPackEntry(  true, Gold,						70.00, "1d10+10" ),
				new LootPackEntry( true, AosMagicItemsPoor,		  0.50, 1, 5, 0, 100 ),
        ...
        public static readonly LootPack SeMeager = new LootPack(new LootPackEntry[]
			{
				new LootPackEntry(  true, Gold,						70.00, "2d10+20" ),
				new LootPackEntry( true, AosMagicItemsMeagerType1,	 10.20, 1, 2, 0, 50 ),
				new LootPackEntry( false, AosMagicItemsMeagerType2,	 5.6, 1, 5, 0, 100 ),
        ...
        public static readonly LootPack SeAverage = new LootPack(new LootPackEntry[]
			{
				new LootPackEntry(  true, Gold,						70.00, "4d10+50" ),
				new LootPackEntry( true, AosMagicItemsAverageType1, 9.75, 1, 4, 0, 75 ),
				new LootPackEntry( false, AosMagicItemsAverageType2, 9.75, 1, 5, 0, 100 ),
        ...
        public static readonly LootPack SeRich = new LootPack(new LootPackEntry[]
			{
				new LootPackEntry(  true, Gold,						 70.00, "8d10+112" ),
				new LootPackEntry( true, AosMagicItemsRichType1,	 38.15, 1, 4, 0, 75 ),
				new LootPackEntry( false, AosMagicItemsRichType2,	 30.85, 1, 5, 0, 100 ),
        ...
        public static readonly LootPack SeFilthyRich = new LootPack(new LootPackEntry[]
			{
				new LootPackEntry(  true, Gold,						   70.00, "2d100+150" ),
				new LootPackEntry( true, AosMagicItemsFilthyRichType1,	39.75, 1, 5, 0, 100 ),
				new LootPackEntry( false, AosMagicItemsFilthyRichType2,	38.8, 1, 5, 25, 100 ),
        ...
        public static readonly LootPack SeUltraRich = new LootPack(new LootPackEntry[]
			{
				new LootPackEntry(  true, Gold,						70.00, "3d100+300" ),
				new LootPackEntry( true, AosMagicItemsUltraRich,	50.00, 1, 5, 25, 100 ),
				new LootPackEntry( false, AosMagicItemsUltraRich,	50.00, 1, 5, 25, 100 ),
				new LootPackEntry( false, AosMagicItemsUltraRich,	50.00, 1, 5, 25, 100 ),
				new LootPackEntry( false, AosMagicItemsUltraRich,	50.00, 1, 5, 33, 100 ),
        ...
        public static readonly LootPack SeSuperBoss = new LootPack(new LootPackEntry[]
			{
				new LootPackEntry(  true, Gold,						70.00, "5d100+400" ),
				new LootPackEntry( false, AosMagicItemsUltraRich,	50.00, 1, 5, 25, 100 ),
				new LootPackEntry( false, AosMagicItemsUltraRich,	50.00, 1, 5, 25, 100 ),
				new LootPackEntry( false, AosMagicItemsUltraRich,	50.00, 1, 5, 33, 100 ),
				new LootPackEntry( false, AosMagicItemsUltraRich,	50.00, 1, 5, 33, 100 ),
				new LootPackEntry( false, AosMagicItemsUltraRich,	50.00, 1, 5, 50, 100 ),
        ...
        public static readonly LootPack AosPoor = new LootPack(new LootPackEntry[]
			{
				new LootPackEntry(  true, Gold,						70.00, "1d10+10" ),
				new LootPackEntry( false, AosMagicItemsPoor,		  0.50, 1, 5, 0, 100 ),
				new LootPackEntry( false, Instruments,	  0.02, 1 )
			});
        ...
        public static readonly LootPack AosAverage = new LootPack(new LootPackEntry[]
			{
				new LootPackEntry(  true, Gold,						70.00, "4d10+50" ),
				new LootPackEntry( true, AosMagicItemsAverageType1, 16.40, 1, 3, 0, 50 ),
				new LootPackEntry( false, AosMagicItemsAverageType1, 9.75, 1, 4, 0, 75 ),
				new LootPackEntry( false, AosMagicItemsAverageType2, 9.75, 1, 5, 0, 100 ),
				new LootPackEntry( false, Instruments,	  0.40, 1 )
			});
        ...
        public static readonly LootPack AosRich = new LootPack(new LootPackEntry[]
			{
				new LootPackEntry(  true, Gold,						 70.00, "8d10+112" ),
				new LootPackEntry( false, AosMagicItemsRichType1,	 38.15, 1, 4, 0, 75 ),
				new LootPackEntry( false, AosMagicItemsRichType2,	 30.85, 1, 5, 0, 100 ),
				new LootPackEntry( false, Instruments,	  1.00, 1 )
			});
        ...
        public static readonly LootPack AosFilthyRich = new LootPack(new LootPackEntry[]
			{
				new LootPackEntry(  true, Gold,						   70.00, "2d100+150" ),
				new LootPackEntry( false, AosMagicItemsFilthyRichType1,	39.75, 1, 5, 0, 100 ),
				new LootPackEntry( false, AosMagicItemsFilthyRichType2,	38.8, 1, 5, 25, 100 ),
				new LootPackEntry( false, Instruments,	  2.00, 1 )
			});
        ...
        private static Type[][] m_NecroTypes = new Type[][]
			{
				new Type[] // low
				{
					typeof( BlankScroll ),typeof( BlankScroll ),typeof( BlankScroll ),typeof( BlankScroll ),typeof( BlankScroll ),typeof( BlankScroll ),typeof( BlankScroll ),typeof( BlankScroll ),typeof( BlankScroll ),typeof( BlankScroll )
				...
				new Type[] // med
				{
					typeof( BlankScroll ),typeof( BlankScroll ),typeof( BlankScroll ),typeof( BlankScroll )
