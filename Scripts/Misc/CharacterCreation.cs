...
namespace Server.Misc
{
	public class CharacterCreation
	{
		...
		private static void FillBankAOS( Mobile m )
		{
			...
			PlaceItemIn( cont, 36, 51, new RunicHammer( CraftResource.MDullcopper, 1000 ) );
			PlaceItemIn( cont, 42, 51, new RunicHammer( CraftResource.MShadow, 1000 ) );
			PlaceItemIn( cont, 48, 51, new RunicHammer( CraftResource.MCopper, 1000 ) );
			PlaceItemIn( cont, 54, 51, new RunicHammer( CraftResource.MBronze, 1000 ) );
			PlaceItemIn( cont, 61, 51, new RunicHammer( CraftResource.MGold, 1000 ) );
			PlaceItemIn( cont, 67, 51, new RunicHammer( CraftResource.MAgapite, 1000 ) );
			PlaceItemIn( cont, 73, 51, new RunicHammer( CraftResource.MVerite, 1000 ) );
			PlaceItemIn( cont, 79, 51, new RunicHammer( CraftResource.MValorite, 1000 ) );
			...
			PlaceItemIn( cont, 37,  35, new ShadowIngot( 5000 ) );
		...
		private static void FillBankbox( Mobile m )
		{
			...
			bank.DropItem( MakeNewbie( new ShadowIngot( 5000 ) ) );
