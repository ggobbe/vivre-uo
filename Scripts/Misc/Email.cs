...
namespace Server.Misc
{
	public class Email
	{
        ...
        public static readonly string EmailServer = "smtp.gmail.com";

        public static readonly string FromAddress = "vivrestaff@gmail.com";

        public static readonly string CrashAddresses = "maeliguul@hotmail.com,tommy.maloteaux@gmail.com,erona1990@gmail.com,johnnylegend@free.fr";
        public static readonly string SpeechLogPageAddresses = "maeliguul@hotmail.com,erona1990@gmail.com,johnnylegend@free.fr,nidal.iguer@gmail.com";
		...
		public static void Configure()
		{
            if (EmailServer != null)
            {
                ...
                // Scriptiz : configuration pour gmail !
                _Client.Port = 587;
                _Client.EnableSsl = true;
                _Client.DeliveryMethod = SmtpDeliveryMethod.Network;
                _Client.UseDefaultCredentials = false;
                _Client.Credentials = new NetworkCredential("vivrestaff@gmail.com", "vkC42r42");    // Identification
            }
		}
		...
		{
            Console.WriteLine("Sending Async Email !");
